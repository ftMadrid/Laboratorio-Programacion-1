...
public class Madrid_Fernando_Fechas {
    ...
    public static void main(String[] args) {
        ...
        int calculoPrimeraFecha = (30 * Integer.parseInt(primerMes)) - (30 - Integer.parseInt(primerDias));
        int calculoSegundaFecha = (30 * Integer.parseInt(segundoMes)) - (30 - Integer.parseInt(segundoDias));
